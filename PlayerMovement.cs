...
using System;
using System.Linq;
using Unity.VisualScripting; // --- ADDED THIS BACK ---
...
public class PlayerMovement : MonoBehaviour, IMovementHandler
{
    ...
    void Awake()
    {
        ...
        // Optimized Component Retrieval via CharacterRoot
    ...
    void Update()
    {
        // 1. Dead Check: Stop everything if downed
        ...
        // 2. Active Player Check: Only process input if we are the currently selected player
    ...
    // --- Helpers (Standard Implementation) ---
